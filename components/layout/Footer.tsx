...
function SupportIcon() {
  return (
    <div className="w-16 h-16 bg-soft-teal rounded-2xl flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li>
                <a href="mailto:hello@allsorted.online" className="hover:text-soft-teal transition-colors">
